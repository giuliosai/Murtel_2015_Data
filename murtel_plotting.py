...
def plot_ro3_daily_ZCsbars_Qg_Qm_vel(temp_hole_15, temp_hole_15_layer, daily_means, 
    ...
    axs[2].plot(pd.to_datetime(surf_vel['time']), surf_vel['horiz_displacement_filt']*1000, 
...
fig, axs = plot_annual_defo_temp_profiles(
    ...
    temp_profiles=temp_data['temp_15_cor_annual'].iloc[1:-1, :],
...
plot_spring_melt_deformation_corrs(corr_data)
